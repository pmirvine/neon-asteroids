...
local ASTEROID = {
    [3] = { radius = 54, score = 20, speedLo = 35, speedHi = 75, fx = 3.2 },
    [2] = { radius = 29, score = 50, speedLo = 55, speedHi = 115, fx = 2.0 },
    [1] = { radius = 15, score = 100, speedLo = 75, speedHi = 165, fx = 1.2 },
}
